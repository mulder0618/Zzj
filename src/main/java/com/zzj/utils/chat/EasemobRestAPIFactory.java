package com.zzj.utils.chat;



import com.zzj.utils.chat.api.EasemobRestAPI;
import com.zzj.utils.chat.api.RestAPIInvoker;
import com.zzj.utils.chat.comm.invoker.HttpClientRestAPIInvoker;
import com.zzj.utils.chat.comm.invoker.JerseyRestAPIInvoker;
...
public class EasemobRestAPIFactory {
	...
	private static final String BASE_PACKAGE = "com.zzj.utils.chat.api.impl";
	...
	private RestAPIInvoker jersey = (RestAPIInvoker) new JerseyRestAPIInvoker();

	private RestAPIInvoker httpclient = (RestAPIInvoker) new HttpClientRestAPIInvoker();
